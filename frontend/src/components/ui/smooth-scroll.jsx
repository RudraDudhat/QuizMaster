      ...
      <main ref={ref} {...props}>
        <article>
          <section className='text-white h-screen w-full bg-slate-950 grid place-content-center sticky top-0'>
            <div className='absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,var(--color-grid-overlay)_1px,transparent_1px),linear-gradient(to_bottom,var(--color-grid-overlay)_1px,transparent_1px)] bg-[size:54px_54px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,var(--color-border)_70%,transparent_100%)]'></div>
